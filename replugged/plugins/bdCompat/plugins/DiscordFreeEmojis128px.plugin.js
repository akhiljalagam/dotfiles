...
function Start() {
    ...
    function replaceEmoji(parseResult, emoji) {
        parseResult.content = parseResult.content.replace(`<${emoji.animated ? "a" : ""}:${emoji.originalName || emoji.name}:${emoji.id}>`, emoji.url.split("?")[0] + "?size=128");
    }
...
return function() { return {
    ...
    getDescription: () => "Link emojis if you don't have nitro! Type them out or use the emoji picker! [128px]",
    getVersion: () => "1.6",
    getAuthor: () => "An0",
